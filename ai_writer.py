...
def read(string):
        ...
        if local_simple[0] == "strategic_number":
            SN.append(
                [
                    local_simple[1]["SnId"],
                    local_simple[3][0],
                    local_simple[7][local_simple[1]["SnId"]],
                    local_simple[4],
                    local_simple[5],
                    local_simple[6],
                    local_simple[9],
    ...
    f.write("|Research\n")
    f.write(
        "TechID,age required,required,requirement count,gametime,goal_checked,goal_id,order\n"
    )
    ...
    f.write("\n|Building\n")
    f.write(
        "BuildingID,age required,max count,required,requirement count,gametime,goal_checked,goal_id,order\n"
    )
    ...
    f.write("\n|Unit\n")
    f.write(
        "UnitID,age required,max count,required,requirement count,gametime,goal_checked,goal_id,order\n"
    )
    ...
    f.write("\n|Strategic Number\n")
    f.write(
        "SnID,age required,value,required,requirement count,gametime,goal_checked,goal_id,order\n"
    )
    ...
    f.write("\n|Attack Rules\n")
    f.write(
        "Type,Age required,Enemy Age Required,population1 type,population1 inq,population1 value,population2 type,population2 inq,population2 value,gametime inq,gametime value,attack %,retreat units,retreat location,goal_id,goal_checked\n"
    )
    ...
    f.write("\n|Goals\n")
    f.write(
        "Goal ID,value,disable after use,checked goal,checked goal value,number of facts used,fact1,params1,fact2,params2,fact3,params3,fact4,params4\n"
    )
    ...
    f.write("\n|Goal actions\n")
    f.write(
        "goal_count,action_count,goal1,goal_value1,goal2,goal_value2,goal3,goal_value3,action1,action1_parameters,action2,action2_parameters,action3,action3_parameters\n"
    )
...
button1 = tk.Button(
    root, text="edit", command=lambda: read(inputtxt.get(1.0, "end-1c"))
)
button1.pack()
...
button2 = tk.Button(
    root, text="commit ai", command=lambda: write_from_csv(inputtxt2.get(1.0, "end-1c"))
)
button2.pack()
...
button2 = tk.Button(
    root,
    text="swap complex",
    command=lambda: swap(inputtxt3.get(1.0, "end-1c"), inputtxt4.get(1.0, "end-1c")),
)
button2.pack()
